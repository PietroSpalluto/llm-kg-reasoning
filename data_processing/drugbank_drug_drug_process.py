...
soup = BeautifulSoup(open("../data/PrimeKG/drugbank/full database.xml"), "xml")
...
(pd.read_csv('interactions_edges.txt', names=['drug1', 'drug2'])
 .to_csv('../data/PrimeKG_processed/drugbank/drug_drug.csv', index=False))
