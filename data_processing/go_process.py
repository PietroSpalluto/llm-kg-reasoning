...
godag = GODag("../data/PrimeKG/go/go-basic.obo")
...
# adding children for each go term (modeling relationships between the elements of the ontology)
edges = set()
...
# conversion from GO index to numerical (example: GO:0031460->31460)
...
all_go_terms.to_csv('../data/PrimeKG_processed/go/go_terms_info.csv', index=False)
edges.to_csv('../data/PrimeKG_processed/go/go_terms_relations.csv', index=False)
