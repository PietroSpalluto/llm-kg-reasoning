...
pth = "../data/PrimeKG/mondo/mondo.obo"
...
# mondo_parents models the relationships between terms of the ontology
mondo_parents = []
for x in data:
    if x._parents:
...
mondo_terms.to_csv('../data/PrimeKG_processed/mondo/mondo_terms.csv', index=False)
mondo_parents.to_csv('../data/PrimeKG_processed/mondo/mondo_parents.csv', index=False)
mondo_xrefs.to_csv('../data/PrimeKG_processed/mondo/mondo_references.csv', index=False)
mondo_subsets.to_csv('../data/PrimeKG_processed/mondo/mondo_subsets.csv', index=False)
mondo_def.to_csv('../data/PrimeKG_processed/mondo/mondo_definitions.csv', index=False)
